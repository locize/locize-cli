...
program
  ...
  .option('--up, --unpublished <true|false>', 'Downloads the current (unpublished) translations. Counts as private downloads: included from the Growth plan on, refused (403) on Free, Starter and Starter-Plus (default: false)', 'false')
  .option('--oo, --overridden-only <true|false>', 'Downloads only the current overridden (unpublished) translations of a tenant or branch project. Counts as private downloads: included from the Growth plan on, refused (403) on Free, Starter and Starter-Plus (default: false)', 'false')
